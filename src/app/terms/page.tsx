  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 text-white">
      ...
      <div className="mt-10 space-y-8 text-slate-300">
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-white">3. Subscriptions, Credits &amp; Billing</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-white">4. Ownership of Generated Code</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-white">6. Service Availability</h2>
          <p>
        ...
        <section>
          ...
          <div className="rounded-xl border border-fuchsia-400/25 bg-fuchsia-400/10 p-4 text-sm text-fuchsia-200">
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-white">8. Changes to These Terms</h2>
          <p>
